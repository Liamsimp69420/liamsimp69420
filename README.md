...
<p> I made this code/guide because when I wanted to do this there were no guides that didn't require an api/100's of python modules and lines of code. I making this so that hopefully someone who needs this can use it. </p>
    <h4> Why not an api?</h4>
    <p> The reason I decided to use the 'split' tool in python for this project is becuase API's can be complicated and expensive. Since I want my computer to yell at me as much as possible I don't want my computer to have to process a few hundred lines of code when just a few will work since having more code would take more time and processing power from my life. And while API's have their uses I just didn't need one for this project so didn't use one. </p> 
